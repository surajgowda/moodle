...
class __Mustache_92d89ada6654927fc2d550593bbef33c extends Mustache_Template
{
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '        <span class="ml-1 ml-md-auto d-flex align-items-center align-self-start">
';
        // 'required' section
