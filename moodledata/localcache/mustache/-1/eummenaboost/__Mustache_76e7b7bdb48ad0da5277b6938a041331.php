...
class __Mustache_76e7b7bdb48ad0da5277b6938a041331 extends Mustache_Template
{
...
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '<footer id="page-footer" class="pt-3 pb-2 bg-dark text-light">
';
...
';
        $buffer .= $indent . '            <div class="col-lg-12 col-xs-12">
';
        $buffer .= $indent . '                <hr class="style-foot"/>
';
        $buffer .= $indent . '                <div class="float-lg-right float-md-right float-sm-right float-xx-left mt-n2 small">Powered by <a href="https://eummena.org/" target="_blank"><img src="';
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= $value;
        $buffer .= '/theme/eummenaboost/pix/eummena_footer.png" class="pr-1" alt="Eummena human logo" title="Eummena human logo"/>Eummena</a> ® - Premium Moodle Partner
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
