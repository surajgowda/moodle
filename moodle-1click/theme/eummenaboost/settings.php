...
if ($ADMIN->fulltree) {   
   // Digital Ocean provides a nice setting page which splits settings onto separate tabs. We want to use it here.                         
    ...
    // Support details.
    $supporthtml= '<div class="support-content-wrapper"><a href="https://eummena.org/" target="_blank">
    <img src="'.$CFG->wwwroot . '/theme/eummenaboost/pix/eummena_logo_small.png"/></a>
    <div class="support-content">'.get_string('supporttitle', 'theme_eummenaboost').'The Moodle 1-click app for DigitalOcean MarketPlace
    is supported by <a href="https://eummena.org/" target="_blank">Eummena</a>, Premium Moodle Partner.<br/> 
    For any feedback or technical support, visit the tracker at:
    <a href="https://github.com/eummena/moodle-1click-do" target="_blank">https://github.com/eummena/moodle-1click-do</a>.
    </div></div>';
    $page->add(new admin_setting_heading('theme_eummenaboost/supporttitle', $supporthtml , NULL));
    // Must add the page after definiting all the settings!
    $settings->add($page);     
